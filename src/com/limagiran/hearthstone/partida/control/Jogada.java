...
import com.limagiran.hearthstone.evento.AtacarLacaiosAdjacentes;
import com.limagiran.hearthstone.evento.Aura;
import com.limagiran.hearthstone.evento.FazerAoAtacar;
import com.limagiran.hearthstone.evento.FimDoTurno;
import com.limagiran.hearthstone.evento.LacaioMorreu;
import com.limagiran.hearthstone.evento.PersonagemAtacando;
import com.limagiran.hearthstone.evento.PersonagemFoiAtacado;
import com.limagiran.hearthstone.evento.PersonagemSendoAtacado;
import com.limagiran.hearthstone.evento.UtilizarPoderHeroico;
import com.limagiran.hearthstone.evento.PoderHeroicoUtilizado;
...
public class Jogada implements Serializable {
    ...
    public void jogar(Pacote pacote) {
        ...
        if (partida != null) {
            ...
            GameCliente.send(Param.REFRESH, Param.VALUE);
        }
    }
    ...
    private void jogarCarta() {
        GameCliente.setBlockSend(false);
    ...
    private void poderHeroico() {
        GameCliente.setBlockSend(false);
        GameCliente.send(Param.ANIMACAO_CARD_JOGADO, partida.getHero().getPoderHeroico().getTipo());
