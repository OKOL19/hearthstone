...
public class Pacote implements Serializable {
    ...
    public Pacote clone() {
        try {
            return RWObj.clone(this, Pacote.class);
        } catch (Exception ex) {
            File file = new File("clonePack.dat");
            RWObj.write(this, file);
            Pacote retorno = RWObj.read(file, Pacote.class);
            file.delete();
            return retorno;
        }
    }
    ...
    /**
     * Retorna os valores da lista separados por vírgula e cada valor entre
     * aspas
     *
