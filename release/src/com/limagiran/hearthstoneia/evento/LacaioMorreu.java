...
public class LacaioMorreu {
    ...
    /**
     * Efígie - Segredo: Quando um lacaio aliado morrer, evoque outro lacaio
    ...
    private static void at_002(Card segredo) {
        if (partida.getOponente().isCard(segredo.id_long)
            ...
            partida.getOponente().evocar(partida.criarCard(Random.getCard(Values.LACAIO, Values.GERAL, card.getCost(),
                            Values.GERAL, Values.GERAL, Values.GERAL).getId(), System.nanoTime()));
