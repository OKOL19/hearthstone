...
public class GameServer implements Runnable {
    ...
    public void run() {
        ...
        final Pacote pacote = new Pacote(Param.PLAYER_INICIO);
        pacote.set(Param.PLAYER_INICIO, random);
        pacote.set(Param.PLAYER, Param.PLAYER_ONE);
        pacote.set(Param.VIDA_TOTAL_HEROI, 30);
        pacote.set(Param.CARTAS_NA_MAO, 10);
        pacote.set(Param.SHIELD_INICIAL, 0);
        String json = pacote.getJSon();
        pacote.set(Param.PLAYER, Param.PLAYER_TWO);
